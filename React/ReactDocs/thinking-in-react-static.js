/*
  To reinforce knowledge and understanding after looking into the original I create a steps
  guide with only the concepts to be used and I try to replicate the code.
*/
